    ...
    protected Boolean doInBackground(Object... args) {
        ...
        while(sentPackets<MAX_NUM_SEND_PACKETS) {
            try {
                ...
                sentPackets++;
                DatagramPacket sendPacket = new DatagramPacket(sendBuffer, sendBuffer.length, InetAddress.getByName(BROADCAST_ADDRESS), BROADCAST_PORT);
    ...
    protected void onPostExecute(Boolean devicesDetected) {
        ...
        devicesListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Intent deviceConfigurationIntent = new Intent(context, DeviceConfiguration.class);
